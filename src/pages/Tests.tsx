...
input: { padding: '6px 8px', border: '1px solid var(--border-color)', borderRadius: '4px', flex: '1 1 120px', fontSize: '12px', backgroundColor: 'var(--input-bg)', color: 'var(--text-primary)', maxWidth: '100%', transition: 'border-color 0.2s, box-shadow 0.2s' },
  textarea: { padding: '6px 8px', border: '1px solid var(--border-color)', borderRadius: '4px', flex: '1 1 120px', fontSize: '12px', minHeight: '40px', maxHeight: '60px', backgroundColor: 'var(--input-bg)', color: 'var(--text-primary)', resize: 'vertical' as const, width: '100%', overflow: 'auto', transition: 'border-color 0.2s, box-shadow 0.2s' },
  select: { padding: '6px 8px', border: '1px solid var(--border-color)', borderRadius: '4px', flex: '1 1 120px', fontSize: '12px', backgroundColor: 'var(--input-bg)', color: 'var(--text-primary)', cursor: 'pointer', transition: 'border-color 0.2s' },
  label: { display: 'block', marginBottom: '3px', fontSize: '11px', fontWeight: '600', color: 'var(--text-secondary)' },
  fileInput: { padding: '6px', border: '1px solid var(--border-color)', borderRadius: '4px', width: '100%', fontSize: '12px', backgroundColor: 'var(--bg-card)' },
  ...
  primaryButton: { padding: '6px 12px', backgroundColor: 'var(--success-color)', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: '600', fontSize: '12px' },
  secondaryButton: { padding: '6px 10px', backgroundColor: 'transparent', color: 'var(--text-secondary)', border: '1px solid var(--border-color)', borderRadius: '4px', cursor: 'pointer', fontWeight: '600', fontSize: '12px' },
  ...
  testModalContent: { maxWidth: '450px', padding: '12px' },
  close: { position: 'absolute' as const, top: '8px', right: '12px', fontSize: '22px', cursor: 'pointer', color: 'var(--text-muted)', transition: 'color 0.2s', width: '26px', height: '26px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%' },
  modalHeader: { marginBottom: '8px' },
  modalSubtitle: { fontSize: '12px', color: 'var(--text-secondary)', marginTop: '4px' },
  formGroup: { marginBottom: '8px', flex: '1 1 100%' as const, minWidth: '100%' },
  formGroupHalf: { marginBottom: '8px', flex: '1 1 180px' as const, minWidth: '150px' },
  formRow: { display: 'flex', gap: '8px', flexWrap: 'wrap' as const, width: '100%' },
  sessionForm: { display: 'flex', flexDirection: 'column' as const, gap: '8px', width: '100%', maxWidth: '420px', margin: '0 auto' },
  testForm: { display: 'flex', flexDirection: 'column' as const, gap: '8px', width: '100%', maxWidth: '420px', margin: '0 auto' },
