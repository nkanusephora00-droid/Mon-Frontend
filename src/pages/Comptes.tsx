...
const styles: any = {
  ...
  modal: { position: 'fixed' as const, top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000 },
  modalContent: { backgroundColor: 'var(--bg-card)', padding: '26px', borderRadius: '16px', width: '92%', maxWidth: '680px', position: 'relative' as const, boxShadow: '0 10px 40px var(--shadow-strong)', border: '1px solid var(--border-light)' },
