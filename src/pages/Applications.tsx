...
const styles: any = {
  ...
  modalContent: { backgroundColor: 'var(--bg-card)', padding: '26px', borderRadius: '16px', width: '92%', maxWidth: '640px', position: 'relative' as const, boxShadow: '0 10px 40px var(--shadow-strong)', border: '1px solid var(--border-light)' },
